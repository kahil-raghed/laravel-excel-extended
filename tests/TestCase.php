...
namespace LaravelExcelExtended\Tests;
...
use LaravelExcelExtended\Providers\FuturesProvider;
...
class TestCase extends OrchestraTestCase
{
    ...
    {
        $app['config']->set('filesystems.disks.local.root', __DIR__ . '/temp');
        $app['config']->set('filesystems.disks.test', [
            'driver' => 'local',
            'root'   => __DIR__ . '/temp/test',
        ]);
